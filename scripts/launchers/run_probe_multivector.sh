...
OUTDIR="$PWD/runs/probe_multivector"
mkdir -p "$OUTDIR"
python scripts/probe_multivector_ranking.py \
  ...
  --output "$OUTDIR/probe_multivector_per_query.csv"
...
src=Path(os.getcwd())/"runs/probe_multivector"
